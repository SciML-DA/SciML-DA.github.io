...
- **Branch naming:** Use `andreanovoa/<short-description>` or `feature/<short-description>` — never `claude/...` or any AI-named prefix.
...
Follow the **ponytail** coding style:
- (Conventions to be defined — see project notes)
